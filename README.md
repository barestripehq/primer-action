...
|-------|----------|---------|-------------|
| `file` | yes | — | Manifest or lockfile to scan (`pyproject.toml`, `package-lock.json`, `Cargo.lock`, etc.) |
...
Linux (x86\_64, ARM64), macOS (Intel, Apple Silicon), and Windows (x86\_64).
